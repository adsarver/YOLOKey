...
from utils.utils import xywh2xyxy, de_parallel, bbox_iou, bbox2dist
from utils.model_utils import dist2bbox, make_anchors
...
class ComputeLoss:
    # Compute losses
    def __init__(self, model, use_dfl=True, params=dict()):
        ...
        self.assigner = TaskAlignedAssigner(topk=params.get('topk', 10),
                                            num_classes=self.nc,
                                            alpha=params.get('alpha', 0.5),
                                            beta=params.get('beta', 6.0))
        self.assigner2 = TaskAlignedAssigner(topk=params.get('topk', 10),
                                            num_classes=self.nc,
                                            alpha=params.get('alpha', 0.5),
                                            beta=params.get('beta', 6.0))
